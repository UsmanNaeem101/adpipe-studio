...
SEGMENT_SECTIONS = [
    {"key": "identity", "title": "Segment", "layer": "segment",
     "fields": [
         ...
         {"key": "awareness", "label": "Awareness level", "kind": "choice",
    ...
    {"key": "evidence", "title": "Evidence", "layer": "customer",
     "fields": [
         {"key": "summary", "label": "Evidence summary", "kind": "long"},
         {"key": "voc_volume", "label": "VOC volume", "kind": "text"},
    ...
    {"key": "fit", "title": "Customer fit", "layer": "customer",
     "fields": [
         {"key": "who", "label": "Who this segment is", "kind": "long"},
         {"key": "why_care", "label": "Why they care", "kind": "long"},
         {"key": "primary_use_case", "label": "Primary use case", "kind": "text"},
         {"key": "secondary_use_cases", "label": "Secondary use cases", "kind": "list"},
         {"key": "context", "label": "Situational context", "kind": "long"},
         {"key": "product_fit", "label": "Relevant product fit", "kind": "long"},
         {"key": "excluded", "label": "Excluded / poor-fit buyers", "kind": "list"},
    ...
    {"key": "problems", "title": "Problem hierarchy", "layer": "customer",
     ...
     "fields": [
         {"key": "main", "label": "Main problem", "kind": "long"},
    ...
    {"key": "benefits", "title": "Benefits", "layer": "strategy",
     ...
     "fields": [
         {"key": "primary", "label": "Primary benefit", "kind": "long"},
         {"key": "secondary", "label": "Secondary benefits", "kind": "list"},
         {"key": "desired_outcomes", "label": "Desired outcomes", "kind": "list"},
         {"key": "rtb", "label": "Reason to believe", "kind": "table",
    ...
    {"key": "strategy", "title": "Strategic conclusions", "layer": "strategy",
     ...
     "fields": [
         {"key": "position", "label": "Segment-specific market position", "kind": "long"},
         {"key": "reason_to_buy", "label": "Primary reason this segment should buy",
          "kind": "long"},
         {"key": "vs_default", "label": "Against their default solution", "kind": "long"},
         {"key": "vs_failed", "label": "Against their failed solutions", "kind": "long"},
         {"key": "vs_amazon", "label": "Against Amazon alternatives", "kind": "long"},
         {"key": "vs_competitors", "label": "Against named competitors", "kind": "long"},
         {"key": "territories", "label": "Messaging territories", "kind": "list"},
     ]},
    {"key": "creative", "title": "Creative (segment-level)", "layer": "strategy",
     "fields": [
         {"key": "demo_ideas", "label": "Best demo ideas for this segment", "kind": "list"},
         {"key": "metaphors", "label": "Visual metaphors", "kind": "list"},
         {"key": "ugc_types", "label": "UGC creator types", "kind": "list"},
         {"key": "scenarios", "label": "Relatable scenarios", "kind": "list"},
         {"key": "pain_viz", "label": "Pain visualisations", "kind": "list"},
         {"key": "outcome_viz", "label": "Desired-outcome visualisations", "kind": "list"},
    ...
    {"key": "compatibility", "title": "Product × segment compatibility", "layer": "strategy",
     ...
     "fields": [
         {"key": "status", "label": "Compatibility", "kind": "choice",
